...
/**
 * struct DispNode - singly linked list
...
int cd_fun(info_s *);
int help_fun(info_s *);
int control_history(info_s *);
int alias_fun(info_s *);
int _getline(info_s *, char **, size_t *);
int _printenv(info_s *);
int setenv_checking(info_s *);
int unsetenv_checking(info_s *);
...
int control_builtin(info_s *);
bool is_executable(info_s *, char *);
int loophsh(char **);
int bfree(void **);
int terminal_prompt(info_s *);
int display_dec(int, int);
int collect_env(info_s *);
